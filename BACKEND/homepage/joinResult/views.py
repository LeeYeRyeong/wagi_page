...
def join_button(request):
    ...
    start_j_date = date(2025, 3, 1) # 지원서 제출 시작 날짜
    end_j_date = date(2025, 3, 17) # 지원서 제 출 끝나는 날짜
    start_r_date = date(2026, 1, 18) # 합격자 조회 시작 날짜
    end_r_date = date(2026, 1, 19) # 합격자 조회 끝나는 날짜
    isDate = 0
